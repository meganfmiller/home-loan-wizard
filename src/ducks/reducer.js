...
let UPDATE_LOAN_TYPE = "UPDATE_LOAN_TYPE";
let UPDATE_PROPERTY_TYPE = "UPDATE_PROPERTY_TYPE";
let UPDATE_CITY = "UPDATE_CITY";
let UPDATE_PROP = "UPDATE_PROP";
let UPDATE_FOUND = "UPDATE_FOUND";
let UPDATE_REAL_ESTATE_AGENT = "UPDATE_REAL_ESTATE_AGENT";
let UPDATE_COST = "UPDATE_COST";
let UPDATE_DOWN_PAYMENT = "UPDATE_DOWN_PAYMENT";
let UPDATE_CREDIT = "UPDATE_CREDIT";
let UPDATE_HISTORY = "UPDATE_HISTORY";
let UPDATE_ADDRESS_ONE = "UPDATE_ADDRESS_ONE";
let UPDATE_ADDRESS_TWO = "UPDATE_ADDRESS_TWO";
let UPDATE_ADDRESS_THREE = "UPDATE_ADDRESS_THREE";
let UPDATE_FIRST_NAME = "UPDATE_FIRST_NAME";
let UPDATE_LAST_NAME = "UPDATE_LAST_NAME";
let UPDATE_EMAIL = "UPDATE_EMAIL";
